...
class OneGarlic extends StatefulWidget {
  @override
  _OneGarlicState createState() => _OneGarlicState();
}

class _OneGarlicState extends State<OneGarlic> {
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: RaisedButton(
              ...
              onPressed: () => launch("tel://7507007001"),
            ),
          ),
          Padding(
