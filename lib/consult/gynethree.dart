...
class ThreeGarlic extends StatefulWidget {
  @override
  _ThreeGarlicState createState() => _ThreeGarlicState();
}

class _ThreeGarlicState extends State<ThreeGarlic> {
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: RaisedButton(
              ...
              onPressed: () => launch("tel://9826385850"),
            ),
          ),
          Padding(
