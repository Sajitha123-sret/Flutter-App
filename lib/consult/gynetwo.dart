...
class TwoGarlic extends StatefulWidget {
  @override
  _TwoGarlicState createState() => _TwoGarlicState();
}

class _TwoGarlicState extends State<TwoGarlic> {
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: RaisedButton(
              ...
              onPressed: () => launch("tel://9809096464"),
            ),
          ),
          Padding(
